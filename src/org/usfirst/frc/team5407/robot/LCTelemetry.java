...
* Dec. 17, 2015 1.01    FWL     Added Java docs and changed a few things. 
*                               1) changed method addHeadedr to addColumn. 
*                               2) changed headerName to columnName. 
*
*</pre>
*<p>			 
* @author Frank Larkin, FRC272 - Lansdale Catholic Robotics - 12-14-2015
* @version 1.0
*   
*/
public class LCTelemetry { 
    ...
    public boolean b_DataSaved;				/** Spreadsheet has been written. Once set to true you cannot do this again until reset.*/ 
    ...
    */
    public void writeRow(){										// save a row of data to memory
        ...
        String s_Mode = "";															// need a string to hold this Mode 
    ...
    */
    public void updatePreferences(){
        ...
        this.sp_FileName = Preferences.getInstance().getString("Tele_FileName", "telemetry"); 
        this.sp_FilePath = Preferences.getInstance().getString("Tele_FilePath", "/tmp"); 
        this.bp_TimestampFile = Preferences.getInstance().getBoolean("Tele_TimestampFile", false);
    ...
    */
    public String getFileName(){										// build up the file name
    	...
    	String s_FullFileName = sp_FilePath + "/" + sp_FileName;
    ...
    */
    public void outputToDashBoard(Boolean b_MinDisplay){
    	...
    	if(driverStation.isDisabled()){									// only acted upon and displayed in disabled mode to save cycles 
    		...
    		SmartDashboard.putBoolean("Tele_DataSaved", b_DataSaved );
    	}
    }
    ...
    */
    public void saveSpreadSheet(){
        ...
        if ( b_DataSaved==false) {
            ...
            b_DataSaved=true;											// mark this true so we do not do it again until code restarted. 
        }
    }
